...
#
# Generated by Vivado on Mon Oct 30 19:04:22 -0400 2023
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/mtlun/Documents/ECE505/Single-Cycle-RISC-V-CPU/LundMatthew_SingleCycle/LundMatthew_SingleCycle.cache/compile_simlib/activehdl"
  fi
