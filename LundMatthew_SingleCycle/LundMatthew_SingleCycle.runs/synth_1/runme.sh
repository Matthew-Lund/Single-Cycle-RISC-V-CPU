...
HD_PWD='C:/Users/mtlun/Documents/ECE505/LundMatthew_SingleCycle/LundMatthew_SingleCycle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SingleCycleTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SingleCycleTop.tcl
